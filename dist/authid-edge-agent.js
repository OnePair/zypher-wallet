...
var AuthIDEdgeAgent = /** @class */ (function () {
    ...
    */
    ...
    AuthIDEdgeAgent.prototype.getPublicKeys = function (protocol, password) {
        var _this = this;
        return new Promise(function (onSuccess, onError) { return __awaiter(_this, void 0, void 0, function () {
            var result, responseCode, publicKeys, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        ...
                        responseCode = 400; // Bad request
                        return [3 /*break*/, 3];
                    case 1: return [4 /*yield*/, this.authID.getPublicKeys(protocol, password)];
                    case 2:
                        publicKeys = _a.sent();
    ...
    AuthIDEdgeAgent.prototype.getSeedPhrase = function (protocol, password) {
        var _this = this;
        return new Promise(function (onSuccess, onError) { return __awaiter(_this, void 0, void 0, function () {
            var result, responseCode, info, wallet, seedPhrase, err_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
    ...
    AuthIDEdgeAgent.prototype.recoverFromSeedPhrase = function (protocol, password, passphrase) {
        var _this = this;
        return new Promise(function (onSuccess, onError) { return __awaiter(_this, void 0, void 0, function () {
            var result, responseCode, info, wallet, err_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
    ...
    */
    AuthIDEdgeAgent.prototype.registerDID = function (protocol, password) {
        var _this = this;
        return new Promise(function (onSuccess, onError) { return __awaiter(_this, void 0, void 0, function () {
            var result, responseCode, did, err_6;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
